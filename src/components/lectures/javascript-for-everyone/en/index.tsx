  ...
  return (
    <Layout>
      ...
      <VideoWrapper duration="30 sec">
        <iframe
          src="https://www.youtube.com/embed/wZOizfA6kmw"
      ...
      <p>
        The student is still on probation at his new company and is still using
        Slack to collaborate with other developers and communicate with
        customers. Ryu writes in the chat one warm spring evening - a former
        customer <em>(returning customer, ya-a-a-ay!)</em>, for whom an online
        resume was previously made. He is completely satisfied with the quality
        of our work and wants to entrust us with another project &mdash;
      </p>
      <SlackMessage
        senderId="ryu"
        senderName="Ryu"
      ...
      <p>
        So, there is no specification, but it seems that this time we are
        talking about a "street fight" simulator - a game in which the player
        chooses two fighters, who in turn fight, slapping each other with their
        hands, feet, and head. Whoever runs out of lives first - loses. In fact,
        they do not die because they are virtual.
      </p>
      <SlackMessage
        senderId="ryu"
        senderName="Ryu"
      ...
      <p>
        🤭Oh ... 🤔Or they die ... The customer didn’t provide any specific
        technical task, so we will make it ourselves. So is the design. Let it
        be just a browser game in the beginning, in which one character
        systematically beats another and vice versa, and a moderately complex
        algorithm determines how hard the blow was inflicted and how much life
        is left in the slow loser who did not have time to dodge to be elbowed
        in the nose. And then we'll see what new functionality or design you can
        manage to code before the deadline. Well, assure the client that
        everything is under control and to work?
      </p>
      <SlackMessage
        senderId="you"
        senderName="You"
  ...
  devServer: {
    port: 9000
      ...
      <VideoWrapper duration="18 sec">
        <iframe
          src="https://www.youtube.com/embed/dSXfRTHzthA"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
          allowFullScreen
        ></iframe>
      </VideoWrapper>
      ...
      <Bubble>
        If you have made it to this point, then congratulations - this is the
        finish 🙂. Thank you for your attention 🙏! I am waiting for questions
        and comments under this lecture in the personal account of{' '}
        <a href="https://academy.binary-studio.com/">
          <strong> Binary Studio Academy</strong>
        </a>
        . And of course - good luck with homework! <strong>Enjoy 🙃</strong>
      </Bubble>
    </Layout>
  );
};
